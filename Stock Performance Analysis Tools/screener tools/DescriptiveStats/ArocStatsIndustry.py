...
def plot_trendline_and_std_ranges(hist, mean_aroc, std_deviation, mean_price, std_prices, ticker):
    ...
    plt.savefig(fr'..\..\test-data\Results\9.22.24\{ticker}_Price_STD.png')
...
def plot_performance_with_aroc_std(hist, mean_aroc, std_deviation, ticker):
    ...
    plt.savefig(fr'..\..\test-data\Results\9.22.24\{ticker}_performance_aroc_std_chart.png')
...
def main():
    tickers_data = load_tickers(r"..\..\test-data\tickers\tickers.json")
    ...
    # Save to Excel
    excel_filename = r"..\..\test-data\Results\9.22.24\LargeCap_Analysis.xlsx"
