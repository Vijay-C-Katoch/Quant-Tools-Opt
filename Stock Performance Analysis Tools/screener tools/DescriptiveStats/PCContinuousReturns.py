...
def plot_trendline_and_std_ranges(hist, mean_aroc, std_deviation, mean_price, std_prices, ticker):
    ...
    plt.savefig(rf'..\..\test-data\Results\9.23.24\{ticker}_Price_STD.png')
...
def plot_performance_with_aroc_std(hist, mean_aroc, std_deviation, ticker):
    ...
    plt.savefig(rf'..\..\test-data\Results\9.23.24\{ticker}_performance_aroc_std_chart.png')
...
def main():
    ...
    # Save to Excel
    excel_filename = rf"..\..\test-data\Results\9.23.24\{size_filter}_Cap_Analysis3d.xlsx"
    ...
    def plot_aroc_bell_curve(aroc_list, log_aroc_list):
        ...
        plt.tight_layout()
        output_dir = r"..\..\test-data\Results/9.23.24"
